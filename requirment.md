...
Objective: Create a professional and responsive portfolio website that showcases your skills,
experience, and projects effectively.
Task Requirements:
...
-Display your professional designation (e.g., Frontend Developer, Web Developer, Full Stack
Developer, etc.).
-Include a professional photo of yourself.
3. Resume Download Button: Follow the following point.
-A clearly visible button in the hero section that allows visitors to view and download your resume
with a single click. (**Resume will be downloaded if your resume is ready. If it is not ready, for
now you can just keep the clickable button.**)
4. Social Links: Follow the following point.
-Embed buttons linking to your relevant social media profiles (e.g., GitHub, LinkedIn, Twitter,
Facebook).
...
-Mention your educational background in detail if you have completed education above HSC. If
not, you can skip this part.
